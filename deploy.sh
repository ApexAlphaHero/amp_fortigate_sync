...
cp "${SCRIPT_DIR}/config-default.yaml" "${INSTALL_DIR}/config-default.yaml"
...
echo ""
echo "Done. Service is running with sync DISABLED."
echo ""
echo "  Verify ports look correct:"
echo "    ${VENV_DIR}/bin/python ${INSTALL_DIR}/src/cli.py query-amp"
echo ""
echo "  Then enable firewall sync when ready:"
echo "    ${VENV_DIR}/bin/python ${INSTALL_DIR}/src/cli.py enable-sync"
echo ""
echo "  Other commands:"
